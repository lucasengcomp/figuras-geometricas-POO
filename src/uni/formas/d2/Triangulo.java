...
public class Triangulo extends FormaD2{
	...
	public Triangulo(float base, float altura, float x1, float y1, float x2, float y2, float x3, float y3) {
		this.base = base;
		this.altura = altura;
	...
	public String toString() {
		...
		return "\nIsto é um Triangulo de coordenadas ("+this.ponto1.getX() +", " +this.ponto1.getY()+ ") , (" + this.ponto2.getX() + ", " +this.ponto2.getY() +") , (" + this.ponto3.getX() + ", " +this.ponto3.getY() +") ";
	}
}
